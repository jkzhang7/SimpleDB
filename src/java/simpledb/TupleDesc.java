...
public class TupleDesc implements Serializable {
    ...
    public TupleDesc(Type[] typeAr, String[] fieldAr) {
        // some code goes here
    	if (typeAr.length == 0) {
    		throw new IllegalArgumentException("Type Array should have at least 1 element");
    	}
...
//        }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
    	...
    	Type[] type_ar = new Type[td1.numFields() + td2.numFields()];
    	String[] field_ar = new String[td1.numFields() + td2.numFields()];
    	for (int i = 0; i < td1.numFields(); i++) {
    		type_ar[i] = td1.tditems[i].fieldType;
    		field_ar[i] = td1.tditems[i].fieldName;
    	}
    	for (int i = 0; i < td2.numFields(); i++) {
    		type_ar[i + td1.numFields()] = td2.tditems[i].fieldType;
    		field_ar[i + td1.numFields()] = td2.tditems[i].fieldName;
    	}
